	...
	private void initToolOptionsContribution(IStatusLineManager statusLine, ToolProxy modalToolProxy){
	    ...
	    if(statusLine != null ){
	    	boolean canAdd = false;
	    	 for (IContributionItem i : statusLine.getItems()) {
             	if (i instanceof GroupMarker && ((GroupMarker)i).getGroupName().equals(StatusLineManager.BEGIN_GROUP)) {
             		canAdd = true;
             		break;
             	}
	    	 }
            if(preferencesShortcutToolOptions == null || preferencesShortcutToolOptions.isDisposed()){
                ...
                if (canAdd)	statusLine.appendToGroup(StatusLineManager.BEGIN_GROUP, preferencesShortcutToolOptions);
            ...
            for(ContributionItem contribution : optionsContribution){
                if (canAdd) statusLine.appendToGroup(StatusLineManager.BEGIN_GROUP, contribution);
